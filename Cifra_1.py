...
def cif():
    ...
    """
    print("Olá, vamos então introduzir a mensagem a cifrar, a respectiva chave, e o nome do ficheiro com a mensagem cifrada!\n")
    # mensagem
    ...
    # chave
    chave = int(input("Qual chave pretendida? (tem que ser um número inteiro compreendido entre 1 e {}) ".format(metade)))
...
def decif():
    ...
    """
    print("Olá, por favor introduza o nome do ficheiro a decifrar e a respectiva chave!\n")
    # mensagem
    nomeFicheiro = input("Qual o nome do ficheiro? ") + '.txt'
    # chave
